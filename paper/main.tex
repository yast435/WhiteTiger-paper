...
\begin{tabular}{p{0.18\linewidth}p{0.10\linewidth}p{0.18\linewidth}p{0.29\linewidth}p{0.24\linewidth}}
\toprule
Dataset & Real robot & Multi-embodiment & Scale & Tasks / Skills \\
\midrule
RoboMIND~\cite{wu2024robomind} & Yes & Yes & 4 embodiments; hours not reported in the abstract & 479 tasks, 96 object classes \\
DROID~\cite{khazatsky2024droid} & Yes & Limited / same robot setup across many sites & 350 hours, 564 scenes & 84 tasks \\
Open X-Embodiment / RT-X~\cite{oneill2023openx} & Yes & Yes & 22 robots from 21 institutions & 527 skills / 160,266 tasks \\
BridgeData V2~\cite{walke2023bridgedatav2} & Yes & Limited / one low-cost robot platform & 24 environments & Multi-task manipulation behaviors \\
\textbf{Baihu v2.0} & \textbf{Yes} & \textbf{Yes} & \textbf{9521.75 hours, 1.03B frames, 14 embodiment tags} & \textbf{2989 tasks} \\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{table}
...
Table~\ref{tab:dataset-comparison} highlights Baihu's distinguishing emphasis on billion-frame scale, multi-embodiment coverage, versioned data management, HDF5-to-LeRobot v2.1 standardization, and direct offline evaluation with GR00T N1.6 checkpoints.
