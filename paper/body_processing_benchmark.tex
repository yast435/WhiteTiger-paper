...
The per-platform results show consistent improvement across all evaluated robot platforms, suggesting that the pretraining effect is not limited to a single dominant embodiment. This is important for Baihu because the dataset is explicitly designed as a multi-embodiment training corpus. Here, Joint-1 and ALL-1 denote the no-training checkpoint, Joint-Baihu and ALL-Baihu denote the Baihu-trained checkpoint, and $\Delta$ denotes relative improvement.
