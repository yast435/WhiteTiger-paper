...
This table defines the English platform names used in the paper and maps them to the original Chinese names and WhiteTiger embodiment tags when available.

| English platform name | Original name | WhiteTiger embodiment tag | Used in benchmark | Notes |
|---|---|---|---|---|
| Qinglong | 青龙 | `qinlongros1`, `qinlongros2` | Yes | Qinglong robot data appears in WhiteTiger v2.0 under ROS1 and ROS2 embodiment tags. |
...
| Zhiyuan G1 | 智元G1 |  | Yes | Benchmark platform name; not currently listed as a WhiteTiger v2.0 embodiment tag in Table 2. |
| Genie1 | Genie1 | `genie1` | No | High-resource WhiteTiger v2.0 embodiment tag; not listed as a benchmark platform in the current offline evaluation table. |

## Naming convention

- Use English platform names in paper text, figures, and tables.
- Keep WhiteTiger embodiment tags in monospace when referring to dataset metadata, for example `qinlongros1` or `genie1`.
