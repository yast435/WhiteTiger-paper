% WhiteTiger v2.0 skill taxonomy table generated from materials/技能.csv.
% Required packages: booktabs, tabularx, adjustbox.

\begin{table}[t]
\centering
\caption{Skill taxonomy of WhiteTiger v2.0. The 64 manipulation skills are grouped according to their action semantics during data collection and annotation.}
