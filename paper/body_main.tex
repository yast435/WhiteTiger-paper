...
\begin{enumerate}
  \item We introduce \textbf{Baihu v2.0}, a billion-frame, multi-embodiment robot manipulation dataset containing 9521.75 hours of data, 2989 tasks, 513575 episodes, and 1028349814 frames across 13 robot platforms for embodied foundation model pretraining.
  ...
  \item We characterize the platform coverage and task composition of Baihu v2.0, providing a clear view of the robot embodiments, manipulation skills, and task categories represented in the dataset.
...
Table~\ref{tab:dataset-comparison} highlights Baihu's scale in terms of episode count, task coverage, and skill diversity. Baihu v2.0 contains 513,575 episodes, 2989 tasks, and 64 manipulation skills.
...
Baihu v2.0 is explicitly multi-embodiment. It covers 13 robot platforms with different robot embodiments, task settings, and action-state schemas. This platform coverage makes Baihu suitable for studying robot data standardization, multi-platform policy training, and cross-embodiment action prediction.
...
This paper focuses on \textbf{Baihu v2.0}, the first completed large-scale version of the Baihu dataset designed for embodied foundation model pretraining. Baihu v2.0 was constructed from robot data available up to April 1, 2026, and was released as a completed dataset version on April 25, 2026. It contains \textbf{9521.75 hours} of robot manipulation data, \textbf{2989 tasks}, \textbf{513575 episodes}, and \textbf{1028349814 frames} across \textbf{13 robot platforms}.
...
\begin{tabular}{lrrrr}
\toprule
Dataset version & Hours & Tasks & Episodes & Frames \\
\midrule
Baihu v1.0 & 2693.34 & 2120 & 144141 & 290880109 \\
Baihu v1.1 / v1.2 & 2451.51 & 1287 & 96474 & 264763101 \\
\textbf{Baihu v2.0} & \textbf{9521.75} & \textbf{2989} & \textbf{513575} & \textbf{1028349814} \\
\bottomrule
\end{tabular}
\end{table}
