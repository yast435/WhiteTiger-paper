...
\begin{enumerate}
  ...
  \item We characterize the platform-level distribution of Baihu v2.0 and show that it contains both high-resource platforms and a long tail of low-resource platforms, providing a foundation for studying cross-embodiment generalization.
...
Baihu v2.0 is explicitly multi-embodiment. It covers 13 robot platforms and a long-tailed distribution across robot platforms. The largest platform contributes 44.67\% of the total duration, while lower-resource platforms provide additional platform diversity. This distribution makes Baihu suitable for studying both high-resource pretraining and cross-embodiment generalization.
